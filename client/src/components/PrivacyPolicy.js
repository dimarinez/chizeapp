...
const PrivacyPolicy = () => {
  return (
    <div style={{ padding: '20px' }}>
      <h1>Privacy Policy for Chize</h1>
      <p>Last updated: January 27, 2024</p>
      <p>
        Thank you for choosing to be part of our community at Chize App ("Company", "we", "us", or "our"). 
        ...
        please contact us at feedback@chizeapp.com.
      </p>
      ...
      <ul>
        ...
        <li>4. Is Your Information Transferred Internationally?</li>
        ...
        <li>12. Do We Make Updates To This Policy?</li>
        <li>13. How Can You Contact Us About This Policy?</li>
        <li>14. User Interactions and Meetups in Chize App</li>
      </ul>
      ...
      <p>
        ...
        <br />
        Personal Information Provided by You. We collect names; phone numbers; location data; photos; email addresses; usernames; passwords; contact or authentication data; and other similar information.
        <br />
...
Vital Interests: We may disclose your information where we believe it is necessary to investigate, prevent, or take action regarding potential violations of our policies, suspected fraud, situations involving potential threats to the safety of any person, and illegal activities, or as evidence in litigation in which we are involved.
      ...
      <p>
        In Short: We are not responsible for the safety of any information that you share with third-party providers who advertise, but are not affiliated with, our app.
        <br />
      ...
      <p>
        ...
        <br />
        If you have questions or comments about your privacy rights, you may email us at feedback@chizeapp.com.
        <br />
        Account Information
...
(2) every individual who is domiciled in the State of California who is outside the State for a temporary or transitory purpose
...
If you are a resident of California, you are granted specific rights regarding access to your personal information. California Civil Code Section 1798.83 permits you to request information regarding the disclosure of your personal information by Chize to third parties for the third parties' direct marketing purposes. To request such information, please contact us using the contact information provided below
      ...
      <h3>14. User Interactions and Meetups in Chize App</h3>
      <p>
        ...
        <br />
        Functionality Overview: Chize App allows users to create personal profiles, access location services, and receive push notifications. For those interested in dating, the app requires male users to check into locations, take selfies, and add descriptions of their whereabouts. Female users can browse these posts in a feed and express interest or pass on them. If a match is made, both parties can view each other's profiles and location descriptions. The app also provides options for finding friends or business partners, with different feed arrangements.
        <br />
        User Responsibility: While Chize App facilitates connections between users, all interactions, whether for dating, friendship, or business networking, occur at the users' own risk. Users must exercise caution and good judgment in their interactions and when deciding to meet in person.
        <br />
        Safety Guidelines: We recommend users:
        <ul>
          <li>Protect personal information and share it cautiously.</li>
          <li>Prefer public and safe places for initial meetings.</li>
          <li>Inform someone trustworthy about their meeting plans.</li>
          <li>Stay alert and prioritize personal safety at all times.</li>
        </ul>
        Liability Disclaimer: Chize App, including its affiliates, officers, directors, employees, agents, and partners, assumes no responsibility for any direct or indirect consequences arising from user interactions and meetings initiated through our App. This includes, but is not limited to, personal safety, data privacy breaches, and any other incidents occurring outside the digital environment of Chize App.
      </p>
    </div>
  );
};
